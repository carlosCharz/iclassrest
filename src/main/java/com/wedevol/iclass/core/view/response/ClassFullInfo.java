...
public class ClassFullInfo implements Serializable {
	...
	public ClassFullInfo() {
	}
	
	public ClassFullInfo(Long id, Long studentId, String studentName, Long instructorId, String instructorName,
	...
	private ClassFullInfo(Long id) {
		this.id = id;
	}

	public static ClassFullInfo from(Long id) {
		return new ClassFullInfo(id);
	}

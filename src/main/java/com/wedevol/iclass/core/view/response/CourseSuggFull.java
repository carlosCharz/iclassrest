...
public class CourseSuggFull implements Serializable {
	...
	public CourseSuggFull(Long id, String userType, Long userId, String courseName, String description, Long facultyId,
			String facultyName, Long universityId, String universityName, Date requestedAt, String status) {
		super();
		this.id = id;

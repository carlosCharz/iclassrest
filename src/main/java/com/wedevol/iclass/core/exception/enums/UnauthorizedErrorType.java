...
public enum UnauthorizedErrorType {
	...
	UNAUTHORIZED_DUE_TO_TOKEN_NOT_FOUND(400, "iClass token not found"), 
	UNAUTHORIZED_DUE_TO_MISMATCH_USER(400, "The user that makes the request does not match with the iClass token associated with him");
